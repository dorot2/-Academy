...
public class StringEqualsExample {
	...
	public static void main(String[] args) {
		...
		String strVar1 = "홍길동"; 
		String strVar2 = "홍길동"; // 힙영역에 새로 기억장소를 생성하지 않고, 앞의 홍길동 데이타 주고사용
		...
		if(strVar1.equals(strVar2)) {
			System.out.println("strVar1과 strVar2는 문자열 데이타 같음.");
		}
		...
		if(strVar3.equals(strVar4)) {
			System.out.println("strVar3과 strVar4는 문자열 데이타 같음.");
		}
	}
