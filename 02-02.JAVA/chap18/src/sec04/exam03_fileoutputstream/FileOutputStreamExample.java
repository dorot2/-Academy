...
public class FileOutputStreamExample {
	...
	public static void main(String[] args) throws Exception {
		// 파일복사
		String originalFileName = "C:\\dorothy\\Program Files\\workspace\\chap18\\src\\sec04\\exam03_fileoutputstream/house.jpg";
		String targetFileName = "C:\\dorothy\\Data\\temp/house2.jpg";
		...
		while((readByteNo = fis.read(readBytes)) != -1) {
			...
			// 맨마지막 while이 동작시 실제 읽은 바이트 수로 저장한다.
