...
public class DataInputOutputStreamExample {
	...
	public static void main(String[] args) throws Exception {
		// 바이트기반스트림 : 바이트 단위로 입출력작업을 한다.
		// 기본데이타타입 boolean, char, short, int, long, float, double 단위는 입출력작업이 불가능.
		
		// 바이트기반 출력스트림
		FileOutputStream fos = new FileOutputStream("C:\\dorothy\\Data\\temp/primitive.dat");
		...
		// 입력스트림작업. 데이타 작업순서대로 읽어와야 한다.(중요)
		FileInputStream fis = new FileInputStream("C:\\dorothy\\Data\\temp/primitive.dat");
